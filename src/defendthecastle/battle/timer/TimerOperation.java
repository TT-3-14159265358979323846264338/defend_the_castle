...
public class TimerOperation {
	...
	public TimerOperation(GameTimer gameTimer, ScheduledExecutorService scheduler) {
	...
	public boolean isRunningFuture() {
		if(future == null) {
			return false;
		}
	...
	public boolean timerPause(Consumer<Long> task) {
