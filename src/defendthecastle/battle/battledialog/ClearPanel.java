...
class ClearPanel extends JPanel{
	...
	ClearPanel(PauseDialog PauseDialog, Stage stage, BattleUnit[] UnitMainData, BattleUnit[] UnitLeftData, BattleFacility[] FacilityData, BattleEnemy[] EnemyData, GameData GameData, double difficultyCorrection) {
		setBackground(new Color(240, 170, 80));
		addOKButton(PauseDialog);
		addMeritScroll(stage, UnitMainData, UnitLeftData, FacilityData, EnemyData, GameData, difficultyCorrection);
	}
	...
	void addMeritScroll(Stage stage, BattleUnit[] UnitMainData, BattleUnit[] UnitLeftData, BattleFacility[] FacilityData, BattleEnemy[] EnemyData, GameData GameData, double difficultyCorrection) {
		meritScroll.getViewport().setView(new ClearMerit(stage, UnitMainData, UnitLeftData, FacilityData, EnemyData, GameData, difficultyCorrection));
		add(meritScroll);
	}
