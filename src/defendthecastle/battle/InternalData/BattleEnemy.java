...
import defendthecastle.battle.timer.MicroSecondsTimerOperation;
import defendthecastle.battle.timer.ScheduleTimerOperation;
...
public class BattleEnemy extends BattleData{
	...
	public BattleEnemy(GameTimer gameTimer, StageData stageData, int number, Difficulty difficulty, ScheduledExecutorService scheduler) {
	...
	public void install(GameData gameData, BattleData[] unitMainData, BattleData[] facilityData, BattleData[] enemyData) {
	...
	protected void defeat(BattleData target) {
		...
		releaseBlock(this);
		gameData.lowMorale(defendthecastle.battle.InternalData.GameData.ENEMY, DEFEAT_MORALE);
