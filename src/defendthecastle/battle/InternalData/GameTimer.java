...
public class GameTimer {
	...
	public GameTimer(MainFrame mainFrame, Stage stage, Difficulty difficulty, ScheduledExecutorService scheduler){
	...
	public void timerStart(GameData gameData, AwakeUnit awakeUnit, StageImage stageImage, BattleUnit[] unitMainData, BattleUnit[] unitLeftData, BattleFacility[] facilityData, BattleEnemy[] enemyData){
	...
	public synchronized void timerWait() {
		if(!hasStoped) {
			return;
		}
		try {
