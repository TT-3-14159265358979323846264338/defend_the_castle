...
public class No0001Stage1 extends StageData{
	...
	@Override
	public List<Boolean> canClearMerit(BattleUnit[] unitMainData, BattleUnit[] unitLeftData, BattleFacility[] facilityData, BattleEnemy[] enemyData, GameData gameData, defaultdata.Difficulty nowDifficulty) {
		return Arrays.asList(canClearStage(Difficulty.NORMAL, nowDifficulty),
				...
				existsOverAwakening(Difficulty.HARD, nowDifficulty, 5, unitMainData),
	...
	public List<List<Integer>> getEnemy() {
		return Arrays.asList(
				...
				Arrays.asList(Enemy.BLUE_SLIME.getId(), 0, 6000, 0, 0),
				Arrays.asList(Enemy.BLUE_SLIME.getId(), 1, 6500, 0, 0),
				Arrays.asList(Enemy.BLUE_SLIME.getId(), 0, 11000, 0, 0),
				Arrays.asList(Enemy.BLUE_SLIME.getId(), 1, 11500, 0, 0),
				Arrays.asList(Enemy.BLUE_SLIME.getId(), 0, 16000, 0, 0),
				Arrays.asList(Enemy.BLUE_SLIME.getId(), 1, 16500, 0, 0),
				
				Arrays.asList(Enemy.GREEN_SLIME.getId(), 0, 26000, 0, 0),
				Arrays.asList(Enemy.RED_SLIME.getId(), 1, 26500, 0, 0),
				Arrays.asList(Enemy.GREEN_SLIME.getId(), 0, 31500, 0, 0),
				Arrays.asList(Enemy.RED_SLIME.getId(), 1, 31500, 0, 0),
				Arrays.asList(Enemy.GREEN_SLIME.getId(), 0, 36000, 0, 0),
				Arrays.asList(Enemy.RED_SLIME.getId(), 1, 36500, 0, 0),
				Arrays.asList(Enemy.GREEN_SLIME.getId(), 0, 41000, 0, 0),
				Arrays.asList(Enemy.RED_SLIME.getId(), 1, 41500, 0, 0),
				
				Arrays.asList(Enemy.YELLOW_SLIME.getId(), 0, 50000, 0, 0),
				Arrays.asList(Enemy.YELLOW_SLIME.getId(), 0, 50500, 0, 0),
				Arrays.asList(Enemy.YELLOW_SLIME.getId(), 1, 53000, 0, 0),
				Arrays.asList(Enemy.YELLOW_SLIME.getId(), 1, 53500, 0, 0),
